<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="Arama.aspx.cs" Inherits="ShopProject.Arama" %>
            ...
            <ul id="gallery">
                ...
                <li>
                    ...
                    <span>
                        ...
                        <asp:ImageButton ID="sepetButon" runat="server" ImageUrl="~/appim/sepet2.jpg" PostBackUrl="~/Sepetim.aspx" />
                    </span>
                </li>
            </ul>
